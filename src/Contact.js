  ...
  <div className="container px-5 py-24 mx-auto" style={{userSelect: 'auto'}}>
    ...
    <div className="lg:w-1/2 md:w-2/3 mx-auto" style={{userSelect: 'auto'}}>
      <div className="flex flex-wrap -m-2" style={{userSelect: 'auto'}}>
        ...
        <div className="p-2 w-full" style={{userSelect: 'auto'}}>
          <button className="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg" style={{userSelect: 'auto'}}>Button</button>
        </div>
